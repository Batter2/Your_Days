...
// const [faqDis, setFaqDis] = useState("block")
            ...
            <Card>
              ...
              <Card.Body>                
                <table border="">
                  ...
                  <tr>
                    <td className="font" style={{display:"none"}} align="center" id="btn1" onClick={toggleBtn1}><img src={img1}/><br></br><br></br>① 마이페이지 ▶ 회원탈퇴
                    <br></br><img src={img2}/><br></br>② 확인 버튼을 누르면 회원탈퇴<br></br><br></br></td>
                  </tr>
                  ...
                  <tr>
                    <td className="font" style={{display:'none'}} align="center" id="btn2" onClick={toggleBtn2}><img src={img1}/><br></br>① 마이페이지 ▶ 비밀번호 변경
                    <br></br>현재 비밀번호, 변경 비밀번호,비밀번호 확인 입력 후<br></br>비밀번호 변경 클릭<br></br>
                    <br></br><span align="left">1) 비밀번호 변경 성공 시</span><br></br>
                    <img src={img3}/><br></br>
                    <br></br>2) 비밀번호 변경 실패 시<br></br><img src={img4}/><br></br></td>
                  </tr>                  
